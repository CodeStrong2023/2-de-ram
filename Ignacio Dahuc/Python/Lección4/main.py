...
# Las listas son lo que se conocen en otros lenguajes como arreglos o vectores
...
print(nombres)
# Iterar una lista
for nombre in nombres: # nombre (variable) es singular, la lista es plural
    print(nombre)
else:
...
planetas.discard('tierra') # Esta función no nos representa ningun error
print(planetas)
...
seleccionArgentina = {
    ...
    11: {'Nombre': 'Ángel Di María', 'Edad': 34, 'Altura': 1.80, 'Precio': '50 Millones', 'Posicion': 'Extremo Derecho'},
    ...
    3: {'Nombre': 'Nicolás Tagliafico', 'Edad': 31, 'Altura': 1.72, 'Precio': '9 Millones', 'Posicion': 'Defensa'},
    24: {'Nombre': 'Enzo Fernández', 'Edad': 22, 'Altura': 1.78, 'Precio': '80 Millones', 'Posicion': 'Centrocampista'},
    26: {'Nombre': 'Nahuel Molina', 'Edad': 25, 'Altura': 1.75, 'Precio': '35 Millones', 'Posicion': 'Defensa'},
