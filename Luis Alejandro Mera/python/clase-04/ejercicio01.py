...
### Forma más corta
group_names = list(set(group_names)) # Primero transforma la lista a un conjunto que filtra los elementos repetidos y luego lo vuelve a transformar en una lista
print(group_names)